...
if (args.Length < 1)
{
    Console.Error.WriteLine("usage: ShinySolution.Tests <path-to-vectors.json> | --emit-gen4-vectors <out.json> | --check-timer-vectors <timer-vectors.json> | --emit-timer-parity <out.json> [count] [seed]");
    return 2;
}
