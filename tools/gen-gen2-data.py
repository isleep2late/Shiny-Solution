...
DATE = "2026-09-03"          # the derivation date (README.md, REVIEW.md), not a run timestamp
...
# The IDs are written 13 frames after the accepting poll in Gold/Silver (REVIEW.md section 5: hJoyPressed on the poll frame, the roll on
...
def main():
    ...
    community = {
        ...
        "note": "REVIEW.md records a second build reproducing all three: identical. These validate the emulator boot the tables share, under a different"
