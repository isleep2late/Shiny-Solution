...
shiny, the exact Trainer ID you want, the one timed press that decides a Gen 1 Trainer ID (and, engine
only so far, a Gen 2 Trainer ID and Lucky ID), and the DS clock time that reaches a chosen Gen 4 seed.
