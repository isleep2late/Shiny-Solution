...
node tools/gen-seedtime4-vectors.cjs [pokefinder-checkout] [out.json]     # regenerate tests/seedtime4-vectors.json (default checkout /tmp/PokeFinder, a scratch clone, not committed)
